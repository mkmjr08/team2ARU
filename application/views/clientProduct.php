...
<body>
    <div style="padding-top: 5%; padding-left: 14.6%; padding-right:0%; font-family: 'Open Sans', sans-serif; ">
            ...
            <?php
                ...
                $sql = "SELECT * FROM tbl_productType WHERE NOT EXISTS (SELECT 1 FROM tbl_chosenProductType WHERE tbl_chosenProductType.pro_id = tbl_productType.pro_id AND tbl_chosenProductType.user_id = $user_id)";
                ...
                <tr>
                    ...
                    <td align="center"><?php $this->load->helper('url'); echo anchor(base_url('clientproductTypeController/AddProductType/'.$row->pro_id.''), 'Add');?></td>
                </tr>
                <?php
                }
