...
if(!isset($_SESSION['Uid'])){
    redirect('clientHomeController/logout2');
}
?>
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar">
             <div class="profile">
                <h3><?php print($_SESSION["Uname"]);   ?></h3>
            ...
            <div>
                ...
                <li>
                        <span class="icon">
                             <?php $this->load->helper('url'); echo anchor(base_url('ClientHomeController/home'), 'Home');?>
                        </span>
                </li>
                <li>
                        <span class="icon">
                            <?php $this->load->helper('url'); echo anchor(base_url('ClientHomeController/'), 'Profile');?>
                        </span>
                </li>
                <li>
                        <span class="icon">
                ...
                <li>
                        <span class="icon">
                            <?php $this->load->helper('url'); echo anchor(base_url('ClientHomeController/idea'), 'Ideas');?>
                        </span>
                </li>
                <li>
                        <span class="icon">
                             <?php $this->load->helper('url'); echo anchor(base_url('ClientHomeController/invested_idea'), 'Invested Ideas');?>
                        </span>
                </li>
                <li>
                        <span class="icon">
    ...
    <div class="topnav">
        <span class="icon">
            <?php $this->load->helper('url'); echo anchor(base_url('clientHomeController/logout'), 'Log Out');?>
        </span>
